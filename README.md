...
[![Build Status](https://img.shields.io/travis/mozilla/accountable/master.svg)](https://travis-ci.org/mozilla/accountable)

[![Coverage status](https://img.shields.io/coveralls/mozilla/accountable/master.svg)](https://coveralls.io/r/mozilla/accountable)

Run the tests
-------------

There's a sample test in `accountable/base/tests.py` for your convenience, that
...
3. Run the image:
    ...
    docker run --env-file env -p 80:8000 mozilla/accountable
